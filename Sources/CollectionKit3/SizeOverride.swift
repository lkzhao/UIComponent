...
public extension Component {
  ...
  func constraint(_ constraintProvider: @escaping (Constraint) -> Constraint) -> Component {
...
public extension ViewComponent {
  ...
  func constraint(_ constraintProvider: @escaping (Constraint) -> Constraint) -> ConstraintOverrideViewComponent<R, Self> {
