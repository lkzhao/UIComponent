...
public struct AnimatorWrapperRenderNode<Content: RenderNode>: RenderNodeWrapper {
    ...
    var insertBlock: ((PlatformView, PlatformView, CGRect) -> Void)?
    var updateBlock: ((PlatformView, PlatformView, CGRect) -> Void)?
    var deleteBlock: ((PlatformView, PlatformView, @escaping () -> Void) -> Void)?
...
extension RenderNode {
    ...
    func animateUpdate(passthrough: Bool = false, _ updateBlock: @escaping ((PlatformView, PlatformView, CGRect) -> Void)) -> AnimatorWrapperRenderNode<Self> {
    ...
    func animateInsert(_ insertBlock: @escaping (PlatformView, PlatformView, CGRect) -> Void) -> AnimatorWrapperRenderNode<Self> {
    ...
    func animateDelete(_ deleteBlock: @escaping (PlatformView, PlatformView, @escaping () -> Void) -> Void) -> AnimatorWrapperRenderNode<Self> {
