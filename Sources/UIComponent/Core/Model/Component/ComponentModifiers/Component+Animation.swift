...
extension Component {
    ...
    public func animateUpdate(passthrough: Bool = false, _ updateBlock: @escaping ((PlatformView, PlatformView, CGRect) -> Void)) -> AnimatorWrapperComponent<Self> {
    ...
    /// - Returns: An `AnimatorWrapperComponent` containing the modified component.
    public func animateInsert(_ insertBlock: @escaping ((PlatformView, PlatformView, CGRect) -> Void)) -> AnimatorWrapperComponent<Self> {
        ModifierComponent(content: self) {
    ...
    /// - Returns: An `AnimatorWrapperComponent` containing the modified component.
    public func animateDelete(_ deleteBlock: @escaping (PlatformView, PlatformView, @escaping () -> Void) -> Void) -> AnimatorWrapperComponent<Self> {
        ModifierComponent(content: self) {
