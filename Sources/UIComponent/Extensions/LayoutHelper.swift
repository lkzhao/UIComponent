...
public protocol BaseLayoutProtocol {
    ...
    @inline(__always) func renderNode(size: CGSize, children: [any RenderNode], positions: [CGPoint]) -> any RenderNode
}
...
extension VerticalLayoutProtocol {
    ...
    @inline(__always) public func renderNode(size: CGSize, children: [any RenderNode], positions: [CGPoint]) -> any RenderNode {
