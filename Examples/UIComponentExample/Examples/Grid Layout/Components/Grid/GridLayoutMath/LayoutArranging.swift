...
enum LayoutArranging {

  static func arrange(task: ArrangingTask) -> LayoutArrangement {
  ...
  static private func arrangeFullyFrozenItems(_ items: inout [ArrangementInfo], flow: GridFlow, occupiedIndices: inout [GridIndex],
  ...
  static private func arrangeSemiFrozenItems(_ items: inout [ArrangementInfo], flow: GridFlow, fixedTracksCount: Int,
  ...
  static private func arrangeNonFrozenItem(_ items: [ArrangementInfo], flow: GridFlow, fixedTracksCount: Int, packing: GridPacking,
                                    occupiedIndices: inout [GridIndex], growingTracksCount: inout Int) -> [ArrangedItem] {
